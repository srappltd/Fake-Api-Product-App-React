  ...
  return (
    <div className='w-full md:w-[80%]'>
      <div className='w-full flex md:hidden px-3 flex-col items-end select-none'>
       <div className='py-2 px-3 border mt-2 whitespace-nowrap text-xs flex items-center justify-center font-medium cursor-pointer' onClick={()=>setFilterMenu(!filterMenu)}>{ search ? decodeURIComponent(search.split('=')[1]) :  'Select Now'} <i class="ri-arrow-down-s-fill"></i></div>
